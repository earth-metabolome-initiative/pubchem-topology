...
mod tests {
    use super::{
        BIPARTITE_GRAPHLET, CARD_DESCRIPTION_WIDTH, CARD_SPECS, format_count, infographic_svg,
        strip_root_svg, wrap_text, write_infographic,
    };
    ...
    fn strip_root_svg_keeps_graphlet_contents_only() {
        let inner = strip_root_svg(BIPARTITE_GRAPHLET);
